...
Enfin la dernière figure montre la disposition des termes diagonaux dans la matrice finale, une fois les réductions faites, comme expliqué dans la section Processus de réduction. On voit que la dispostion des termes est toujours bonne. Le rang de la nouvelle matrice est $253$, c'est la dimension du quotient $A$, d'après la Conjecture 1.
\begin{center}
