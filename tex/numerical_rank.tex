...
\begin{exmp}
Nous choisissons $n = 4$ et un système polynomial $f$ de multidegré $d = (2, 2, 2, 2)$. Chaque polynôme possède $m = 15$ monômes. Les degrés sont choisis aléatoirement suivant une loi uniforme entre $0$ et $2$:
\input{degrees.tex}
Les coefficients, entiers, sont choisis aléatoirement suivant une loi uniforme entre $-5$ et $5$:
\input{coeffs.tex}

La matrice de Bezout $B(1)$ est de taille $576$. Si on effectue une factorisation QRP sur cette matrice, on sait que les éléments diagonaux seront triés en ordre décroissant, voir figure ci-dessous.
\end{exmp}
\begin{center}
\includegraphics[width=15cm]{../png/bez_beztri.png}
\end{center}
